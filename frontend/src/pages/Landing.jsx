...
const Landing = ({ onNavigate }) => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      {/* Hero Section */}
      <section className="relative py-12 sm:py-20 px-2 sm:px-4 md:px-6 lg:px-8 overflow-visible">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <h2 className="text-3xl sm:text-5xl font-bold text-gray-900 mb-4 sm:mb-6 leading-tight">
            <span className="block">AI-Powered Smart City</span>
            <span className="block text-2xl sm:text-4xl bg-gradient-to-r from-blue-600 to-green-600 bg-clip-text text-transparent mt-1 sm:mt-2 relative z-10">
              Management Platform
            </span>
          </h2>
          <p className="text-base sm:text-xl text-gray-600 mb-8 sm:mb-12 max-w-3xl mx-auto leading-relaxed relative z-10">
            Transform Indian cities with intelligent traffic management,
            predictive infrastructure monitoring, and citizen-centered urban
            planning. Built for sustainable, inclusive, and smart urban growth.
          </p>
        ...
        {/* Decorative background gradient behind text, pushed down for clarity */}
        <div className="absolute inset-x-0 top-0 h-2/3 pointer-events-none z-0">
          <div className="w-full h-full bg-gradient-to-b from-blue-100 via-white to-green-100 opacity-80 blur-md"></div>
        </div>
      </section>
            ...
            {[
              {
                ...
                description:
                  "AI-powered congestion prediction, adaptive signals, and route optimization for smoother urban mobility.",
              ...
              },
              {
                ...
                description:
                  "Real-time detection of potholes, bridge damage, and streetlight failures using computer vision.",
              ...
              },
              {
                ...
                description:
                  "Smart bin sensors, overflow prediction, and optimized collection routes for cleaner cities.",
              ...
              },
              {
                ...
                description:
                  "Instant accident detection, disaster alerts, and automated emergency service coordination.",
              ...
              },
              {
                ...
                description:
                  "AI-driven insights for urban planning, resource allocation, and sustainable city development.",
              ...
              },
              {
                ...
                description:
                  "Easy issue reporting, transparent tracking, and inclusive participation in city planning.",
            ...
            <ul className="space-y-3 sm:space-y-4">
              {[
                ...
                >
                  ...
                  <span className="text-blue-50 text-xs sm:text-base">
                    {problem}
                  </span>
                </li>
              ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            ...
            >
              ...
              <p className="text-gray-600 text-xs sm:text-sm">
                Monitor city-wide metrics and manage operations
              </p>
            </button>
            ...
            >
              ...
              <p className="text-gray-600 text-xs sm:text-sm">
                Citizens can report problems and track solutions
              </p>
            </button>
